...
files=(
  ...
  supabase/migrations/202608030001_dashboard_rollup.sql
...
grep -q "vgi_dashboard_rollup" supabase/functions/visitor-dashboard/index.ts
grep -q "rateLimit" wakimotocorp-site/netlify/edge-functions/analytics-ingest-proxy.ts
